...
for generation in range(num_generations):
    ...
    max_r2.to_csv('/home/wangping/3_GA/320_0.75_Yield/max_r2(' + Model + ").csv", mode='a', header=False)
    best_individual = population[np.argmax(fitness_scores)]
    pd.DataFrame([best_individual], index=[generation]).to_csv('/home/wangping/3_GA/320_0.75_Yield/best_individual(' + Model + ").csv", mode='a', header=False)
    ...
    selected_features.to_csv('/home/wangping/3_GA/320_0.75_Yield/selected_features(' + Model + ").csv", mode='a', header=False)
