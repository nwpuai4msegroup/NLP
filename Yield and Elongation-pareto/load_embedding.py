...
#Retrieve the last row of the worksheet
...
def main(_):
    ...
    #Create a new Excel file and write the title line (if the file does not exist)
    ...
    batch_size = 5
    batch_data = []
    #Read JSON files by line and process them
